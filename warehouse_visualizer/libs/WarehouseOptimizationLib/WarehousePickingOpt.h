...
/// @brief type for specifing algorithm for solving BPP
enum BPAlgorithms
{
...
/// @brief type for specifing algorithm for solving grouping of customers items to carts
...
/// @brief type for specifing algorithm for solving shortest path problem while sorting items in cart
...
public:
    ...
    /// @brief when selected K-means clustering, this is maximal number of iterations
    int Number_of_K_Means_Iterations = 40;
    /// @brief when selected K-means clustering, this is the optimal koeficient for multiplying portion (volume of wave)/(volume of cart)
